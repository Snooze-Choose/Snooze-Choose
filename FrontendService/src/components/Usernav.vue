  ...
  <DropdownMenu>
    ...
    <DropdownMenuContent class="w-56" align="end">
      ...
      <DropdownMenuGroup v-if="isAuthenticated">
        ...
        <DropdownMenuItem @click="navigateTo('order')">Meine Bestellungen</DropdownMenuItem>
      ...
      <DropdownMenuGroup v-if="isAuthenticated == false">
        <DropdownMenuItem @click="keycloak.login()">Login</DropdownMenuItem>
        <DropdownMenuItem @click="keycloak.register()">Registrieren</DropdownMenuItem>
      </DropdownMenuGroup>
    </DropdownMenuContent>
  </DropdownMenu>
</template>
