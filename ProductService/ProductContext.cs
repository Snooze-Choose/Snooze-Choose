...
namespace ProductService
{
    ...
    public static class DbInitializer
    {
            ...
            var products = new List<Product>
        {
            ...
            new Product { Name = "Kaffemaschine", Price = 89.00m, LongDescription = "Vollautomatische Kaffeemaschine für perfekten Kaffeegenuss zu Hause – von Espresso bis Latte.", ShortDescription = "Frisch gebrühter Kaffee, jederzeit. Einfach zu bedienen.", Rating = 4.60m, ImageUrl = "/images/coffeemachine.png" },
